...
function [PESQ_MOS,MOS_LQO,MOS_LQO_WB] = PESQ_evl(pathaudio,reference,degraded,fs)
...
%clear all; close all; clc;
   ...
   % degraded2 = 'dg105.08k.raw';
    ...
    nb = pesq2_mtlb( reference, degraded, fs, 'nb', binary, pathaudio );
    wb = pesq2_mtlb( reference, degraded, fs, 'wb', binary, pathaudio );
